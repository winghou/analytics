        ...
        return (
            <div>
                <div style={css.from}>
                    ...
                    <div style={css.item}>
                        <span style={{width:'50px'}}>url:</span><antd.Input onChange={this.changeUrl} placeholder="url" style={{margin:'0 40px 0 10px'}} />
                    </div>
                    <div style={css.item}>
                         <span style={{width:'100px'}}>错误内容:</span><antd.Input onChange={this.changeErrorContent} placeholder="错误内容" style={{margin:'0 40px 0 10px'}} />
                    </div>
                    <antd.DatePicker onChange={ this.onChange}  defaultValue={moment(this.props.day, 'YYYY-MM-DD')}  style={{width:'200px',margin:'0 40px 0 10px'}}/>
                    <div  style={css.item}>
                ...
                <Drawer onClose={this.onClose} visible={this.state.visible} data={this.state.errorData} project={this.props.project}  day={this.state.day}/>
            </div>
        )
    }
}
